...
module.exports = async function contentfulFetch({
  ...
  const contentfulClientOptions = {
    ...
    responseLogger: response => {
      ...
      if (response.config.url === `sync` && !response.isAxiosError && (response === null || response === void 0 ? void 0 : response.data.items)) {
  ...
  try {
    ...
    while (!syncSuccess) {
      try {
        ...
        if (((_e$response = e.response) === null || _e$response === void 0 ? void 0 : (_e$response$data = _e$response.data) === null || _e$response$data === void 0 ? void 0 : _e$response$data.message.includes(`Response size too big`)) && currentPageLimit > 1) {
